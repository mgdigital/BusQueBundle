        ...
        $rootNode
            ->children()
                ->arrayNode('implementation')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('auto_queue_resolver')->defaultValue('busque.queue_resolver.classname')->end()
                        ...
                        ->scalarNode('base_commandbus_adapter')->defaultValue('busque.commandbus_adapter.tactician')->end()
                        ->scalarNode('commandbus_adapter')->defaultValue('busque.commandbus_adapter.auto_queue')->end()
                ...
                ->arrayNode('queues')
                    ...
                    ->children()
                        ...
                        ->variableNode('whitelist')->defaultValue(['default'])->end()
                    ->end()
                ->end()
                ->arrayNode('auto_queue')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->variableNode('classnames')->defaultValue([])->end()
                    ->end()
                ->end()
            ->end()
        ->end();
